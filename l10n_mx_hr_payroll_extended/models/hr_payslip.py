...
class HrPayslip(models.Model):
    ...
    # FUCION DESACTIVADA TEMPORALMENTE
    # @api.model
    ...
    # FUNCION DESACTIVADA TEMPORALMENTE POR QUE REMPLAZA LA ORIGINAL
    ...
    #         # },
    #         **{
    #             "categories": (employee.id, {}, self.env),
    #             "rules": (employee.id, {}, self.env),
    #             "payslip": (employee.id, self, self.env),
    #             "worked_days": (employee.id, worked_days_dict, self.env),
    #             "inputs": (employee.id, inputs_dict, self.env),
    #             "employee": employee,
    #             "contract": contract,
    #             "result_rules": (employee.id, {}, self.env),
    #         },
    #     }
    #     return localdict

    # FUNCION DESACTIVADA TEMPORALMENTE YA QUE REMPLAZA LA ORIGINAL
